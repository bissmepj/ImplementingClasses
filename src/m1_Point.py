...
class Point(object):
    ...
    def __repr__(self):
        to_print = "Point(" + str(self.x) + ", " + str(self.y) + ")"
        return to_print
    ...
    def get_distance_from_start(self):
        dx = self.x - self.init_x
        dy = self.y - self.init_y
        return math.sqrt((dx ** 2) + (dy ** 2))
...
def run_test_repr():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 4.  Follow the same instructions as in ____ 3 above,
...
def run_test_clone():
   ...
   """
    # ------------------------------------------------------------------
    # DONE: 5.  Follow the same instructions as in ____ 3 above,
...
def run_test_move_to():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 6.  Follow the same instructions as in ____ 3 above,
...
def run_test_move_by():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 7.  Follow the same instructions as in ____ 3 above,
...
def run_test_get_number_of_moves_made():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 8.  Follow the same instructions as in ____ 3 above,
...
def run_test_get_distance_from():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 9.  Follow the same instructions as in ____ 3 above,
...
def run_test_get_distance_from_start():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 10.  Follow the same instructions as in ____ 3 above,
...
def run_test_get_distance_traveled():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 11.  Follow the same instructions as in ____ 3 above,
...
def run_test_closer_to():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 12.  Follow the same instructions as in ____ 3 above,
...
def run_test_halfway_to():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 13.  Follow the same instructions as in ____ 3 above,
